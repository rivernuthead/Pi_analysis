...
for i, set_name in enumerate(set_names):
    ...
    plt.savefig(os.path.join(home_dir, 'output', f'comp_thrs_filt_plot_{set_name}.pdf'), dpi=800, bbox_inches='tight')
    plt.show()
    ...
    report_file_path = os.path.join(home_dir, 'output', f'curve_report_{set_name}.txt')
