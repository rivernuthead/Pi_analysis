...
for run in runs:
    ...
    report_dir = os.path.join(home_dir, 'output_data', 'reports', run)
    if not(os.path.exists(os.path.join(home_dir,  'output_data', 'plots'))):
        os.mkdir(os.path.join(home_dir,  'output_data', 'plots'))
    plot_dir = os.path.join(home_dir,  'output_data', 'plots', run)
