...
for run_name in run_names:
    ...
    if 'full_BAA_stack' in run_mode:
        ...
        test = np.load('/home/erri/Documents/PhD/Research/5_research_repos/PiQs_analysis/activity_stack/q05r1_envBAA_act_period_LR5.npy')
...
np.save(os.path.join(report_dir, set_name + '_envBAA_act_4th_period_maps_single_runs.npy'), envBAA_act_period_stack_4th)
